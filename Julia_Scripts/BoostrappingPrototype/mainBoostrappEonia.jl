...
##################################load Data#############################################
#Tasas:
path = "C:\\Users\\jaime.valenzuela\\Documents\\Julia_Scripts\\BoostrappingPrototype\\bidaskEonia.csv"
...
#Definiciones/Datos
fechaStrHoy = "20200519"#una forma de refactorizar esto es que sea un vector de fechas que vaya desde t hasta settlement date
notional = 1.0
n = length(rates[:, 1])
settlementDays = 2
...
XLSX.writetable(string(fechaStrHoy, " Eonia Curve.xlsx"),
